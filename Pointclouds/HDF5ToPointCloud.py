...
#path to file:
path = "/Users/kristinagessel/Downloads/h5pyfile_training2.h5"#"/Users/kristinagessel/Desktop/ProjectExperiments/floodfill-network/ffn-github-repo/test_h5pyfile.h5"
path_to_validation = "/Volumes/Research/1. Research/Experiments/M910TrainingSubvolumes/validation/250/gray_x1752_y486_s0/"

out_file = open("point_cloud_test_volumesample.txt", 'w')
f = h5py.File(path, 'r')
